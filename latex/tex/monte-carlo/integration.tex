...
\begin{figure}[ht]
  ...
  \begin{subfigure}[c]{.49\textwidth}
    ...
    \caption[\(2\pi\dv{\sigma}{\theata}\) with integration
...
The idea behind \vegas\ is to subdivide \(\Omega\) into hypercubes and
define \(\rho\) as step-function on those hypercubes, iteratively
