...
Generating \result{xs/python/4imp-sample-size} samples, the histograms
in~\ref{fig:histos} are created. \Ref{fig:histos} also contains
...
\begin{figure}[p]
  ...
  \begin{subfigure}[b]{.49\textwidth}
    \centering \plot{xs_sampling/histo_eta}
    \caption{\label{fig:histeta} Histogram of the pseudo-rapidity
      (\(\eta\)) distribution.}
  \end{subfigure}
  \begin{subfigure}[b]{.49\textwidth}
    \centering \plot{xs_sampling/histo_pt}
