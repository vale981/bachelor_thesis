...
some observables are depicted in~\ref{fig:pdf-histos}. The
...
in~\ref{sec:ppruncard} and~\ref{sec:ppanalysis}. When
comparing~\ref{fig:pdf-eta} with \ref{fig:histeta} it becomes
