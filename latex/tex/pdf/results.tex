...
\cref{eq:sangle,eq:sangle-cs}. The scattering angle is a measure for
the angular separation the photons, that is most meaningful when the
azimuthal separation of the photons is \(\pi/2\) (i.e. in their
c.m. frame). Here, the partons are assumed to have no transverse
momentum and therefore the system is symmetric around the beam
axis. When allowing transverse parton momenta, as will be done
in % TODO: REFERENCE
...
histograms in \cref{fig:pdf-o-angle,fig:pdf-o-angle-cs} are the same.
