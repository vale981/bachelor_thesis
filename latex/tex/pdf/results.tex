...
same. The distribution of the opening angle is quite flat, apart from
the regions near \(|\cos\theta^\ast| = 1\), where the cuts are taking
effect. This is again a clear difference to the partonic distribution
in \cref{fig:distcos}. % TODO: diskussion?
