...
(c.m.) frame unless stated otherwise. The momenta used in the
c.m. frame are concretized to in \cref{eq:pchoice} as illustrated in
\cref{fig:qqimpulses}.  Note that the photons are aligned to the
