...
The result obtained in~\ref{sec:qqggcalc} shall now be verified by the
...
result~\eqref{eq:crossec} arises. The differential cross section has
...
the same parameters into~\eqref{eq:total-crossec} gives
