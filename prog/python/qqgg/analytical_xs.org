...
#+RESULTS:
: IntegrationResult(result=0.05603848940862068, sigma=0.0009768838692834352, N=2371)
...
#+RESULTS:
: IntegrationResult(result=0.0549039982637097, sigma=0.0009598806807405454, N=140)
...
#+RESULTS:
: VegasIntegrationResult(result=0.05379760909268726, sigma=0.00013423533117681597, N=2805, increment_borders=array([0.16380276, 0.2371802 , 0.34518014, 0.50853601, 0.76987758,
:        1.23206491, 1.91747482, 2.37289096, 2.63298573, 2.79633319,
:        2.90455218, 2.9777899 ]), vegas_iterations=20917)
...
#+RESULTS:
: VegasIntegrationResult(result=0.05379820476333121, sigma=1.9874405070796844e-05, N=2805, increment_borders=array([0.16380276, 0.2372247 , 0.34505187, 0.507357  , 0.76660567,
:        1.22641976, 1.91195318, 2.3726804 , 2.63273347, 2.79651401,
:        2.90481052, 2.9777899 ]), vegas_iterations=2091)
...
#+RESULTS:
[[file:./.ob-jupyter/7a19a49df55d698f906d1da3db6ec6236a1fdcfb.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/52f3091ff35d68fb63063d2e10d311a494e72ef4.png]]
...
:RESULTS:
: Trying cache
: array([[100.        ,  78.35413155,  34.46901415, -51.69639381],
:        [100.        ,  81.07148059,  14.47424175, -56.72663713],
:        [100.        ,  77.36318011,   8.21342863,  62.82895792],
:        ...,
:        [100.        ,  80.58135399,  25.08124354, -53.64304812],
:        [100.        ,  25.93965904,  34.44071517,  90.22733082],
:        [100.        ,  40.226258  ,   1.92028743,  91.53229301]])
:END:
...
#+RESULTS:
[[file:./.ob-jupyter/3cb17d97c64d5f1a124eabf9585960d0d8d351b0.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/66bfdb7d4601822122756fbd33048b315d15cc29.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/ea810d8ad8b8ca3c43580ac3d6dbc9f217c513a7.png]]
...
#+RESULTS:
: array([-0.9866143 , -0.96970261, -0.9313044 , -0.83929434, -0.60693423,
:        -0.00699652,  0.60153398,  0.83913868,  0.9310874 ,  0.96992885,
:         0.9866143 ])
...
#+RESULTS:
:RESULTS:
: <matplotlib.legend.Legend at 0x7f484cce65e0>
[[file:./.ob-jupyter/27f987a9462f00ef9f6758bfa18de04948e842f8.png]]
:END:
...
#+RESULTS:
[[file:./.ob-jupyter/67cfb4d2d954fa87e052b25cfe66cb4adb5c3a97.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/7ea42bec0fdbab7eb941bed1f1fef3a6683170ac.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/cc7d015cba5713359f075b4c01c754e0ad92977c.png]]
...
#+begin_src jupyter-python :exports both :results raw drawer
  ...
  for key, sherpa_hist in sherpa_histos.items():
      ...
      save_fig(fig, "histo_sherpa_" + key, "xs_sampling", size=(4, 4))
#+end_src

#+RESULTS:
:RESULTS:
[[file:./.ob-jupyter/ec6db0dc7993e72fcca5007c13d113e7ed446cfa.png]]
[[file:./.ob-jupyter/8789008762d583cf6a19452c8d55474730cf974c.png]]
[[file:./.ob-jupyter/1df99392bbc41afbdeeb5d32239421a8c33f7599.png]]
:END:
