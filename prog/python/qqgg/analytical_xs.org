...
#+RESULTS:
: IntegrationResult(result=0.05422232456151445, sigma=0.0007862791173166955, N=3295)
...
#+RESULTS:
: IntegrationResult(result=0.05304401590181651, sigma=0.0009469437083378801, N=140)
...
#+RESULTS:
: VegasIntegrationResult(result=0.053790905245890086, sigma=0.00013452195164874084, N=2805, increment_borders=array([0.16380276, 0.23694379, 0.34447252, 0.50729665, 0.76854077,
:        1.23013391, 1.91378935, 2.37360825, 2.633649  , 2.79674185,
:        2.904459  , 2.9777899 ]), vegas_iterations=8520)
...
#+RESULTS:
: VegasIntegrationResult(result=0.053786278890873125, sigma=2.1028547083203354e-05, N=2805, increment_borders=array([0.16380276, 0.23735356, 0.34535862, 0.50842598, 0.76909894,
:        1.22951184, 1.91675759, 2.37328575, 2.63331728, 2.79642897,
:        2.9040894 , 2.9777899 ]), vegas_iterations=1666)
...
#+RESULTS:
[[file:./.ob-jupyter/65951908a1593dc300790a3faf8a2ff841ec6bb0.png]]
...
#+RESULTS:
:RESULTS:
: [-0.9866142369626897, 0.9866142687835138]
[[file:./.ob-jupyter/6a20174e90e8d7fec7fe1a8e75e7aa8141c6a6a5.png]]
:END:
...
:RESULTS:
: Trying cache
: array([[100.        ,  78.00049253,  62.56919226,  -1.00962639],
:        [100.        ,  62.43974187,   3.11947703,  78.04836641],
:        [100.        ,  45.33451787,  25.58190352,  85.38353296],
:        ...,
:        [100.        ,  60.8315485 ,  37.03044251,  70.20163128],
:        [100.        ,  34.59697445,  12.31337004, -93.01306509],
:        [100.        ,  35.98519739,   6.00902058,  93.10723517]])
:END:
...
#+begin_src jupyter-python :exports both :results raw drawer
  ...
  fig, ax = draw_histo_auto(η_sample, r'$eta$', range=interval_η)
...
:RESULTS:
: [-2.5, 2.5]
[[file:./.ob-jupyter/7c26e1d3374b71e56edd9803178c9bf1d4676d5a.png]]
:END:
...
#+begin_src jupyter-python :exports both :results raw drawer
  ...
  fig, ax = draw_histo_auto(p_t_sample, r"$p_T$ [GeV]", range=interval_pt)
  save_fig(fig, "histo_pt", "xs_sampling", size=[3, 3])
#+end_src

#+RESULTS:
:RESULTS:
: [16.307123192997782, 100.0]
[[file:./.ob-jupyter/8a05e5affd2aa99eb64feac9e085c031fee5ca92.png]]
:END:
...
#+begin_src jupyter-python :exports both :results raw drawer
  draw_histo_auto(η_sample, r'$\eta$')
#+end_src

#+RESULTS:
:RESULTS:
: [-2.4999918724628603, 2.4999999430360855]
| <Figure | size | 432x288 | with | 1 | Axes> | <matplotlib.axes._subplots.AxesSubplot | at | 0x7fcd645700d0> |
[[file:./.ob-jupyter/12ccbd8470fc6ba2cca59cd09f9338b11a2c53dc.png]]
:END:
...
#+RESULTS:
: array([-0.9866143 , -0.96981259, -0.93135441, -0.83976606, -0.60153989,
:         0.00107776,  0.60241559,  0.83787241,  0.93090122,  0.96950407,
:         0.9866143 ])
...
#+RESULTS:
:RESULTS:
: <matplotlib.legend.Legend at 0x7fcd69c05550>
...
#+RESULTS:
[[file:./.ob-jupyter/d40c98bba7d04c25ccc1dac2554fc363c25366d4.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/4c9eb494db1a3be4d48ab7ad1644c8c6f9f9ef6a.png]]
...
#+RESULTS:
:RESULTS:
: [-0.9866137965902264, 0.9866140936263373]
[[file:./.ob-jupyter/d99b44ca189bea7a04a56923493ae5bf85c69f10.png]]
:END:
