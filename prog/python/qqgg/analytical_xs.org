...
#+begin_src jupyter-python :exports both :results raw drawer
  xs_pb_mc, xs_pb_mc_err = monte_carlo.integrate(xs_pb_int, interval, 100000)
  xs_pb_mc = xs_pb_mc
  xs_pb_mc, xs_pb_mc_err
#+end_src

#+RESULTS:
| 0.05388966591629671 | 5.033605571755944e-05 |
...
#+RESULTS:
:RESULTS:
| <matplotlib.lines.Line2D | at | 0x7f9c91fef190> |
...
#+RESULTS:
[[file:./.ob-jupyter/b51052005c8adf520b2a3d8133b0192b378ab349.png]]
...
#+RESULTS:
: array([[100.        ,  78.6513978 ,  25.03974819, -56.4532429 ],
:        [100.        ,  80.50316938,   1.23982425,  59.31022303],
:        [100.        ,  37.34488027,  25.09007454,  89.30760369],
:        ...,
:        [100.        ,  27.28611517,  11.11891923,  95.56064856],
:        [100.        ,  49.67818369,  55.52508519,  66.70114676],
:        [100.        ,  32.95364669,   8.54598622,  94.02671583]])
...
#+RESULTS:
:RESULTS:
| <Figure | size | 432x288 | with | 1 | Axes> | <matplotlib.axes._subplots.AxesSubplot | at | 0x7f9c92128520> |
[[file:./.ob-jupyter/9c85532fa94e9e0b01a6201f9308c5002176d073.png]]
:END:
...
#+RESULTS:
:RESULTS:
| <Figure | size | 432x288 | with | 1 | Axes> | <matplotlib.axes._subplots.AxesSubplot | at | 0x7f9c9210d5e0> |
[[file:./.ob-jupyter/814509eb1779574dce1de9a9fe093e067f30ff33.png]]
:END:
