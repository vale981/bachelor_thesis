...
#+RESULTS:
: IntegrationResult(result=0.052122306114862786, sigma=0.0008976937688337722, N=2499)
...
#+RESULTS:
: IntegrationResult(result=0.05516763764241838, sigma=0.0009401394981766643, N=135)
...
#+RESULTS:
: VegasIntegrationResult(result=0.05374332974380386, sigma=0.00013119911512982728, N=2805, increment_borders=array([0.16380276, 0.23734611, 0.34564805, 0.5092056 , 0.77014734,
:        1.22678512, 1.91270094, 2.3742263 , 2.6333199 , 2.79565774,
:        2.90399568, 2.9777899 ]), vegas_iterations=9726)
...
#+RESULTS:
: VegasIntegrationResult(result=0.05379279312214714, sigma=1.7484144066819456e-05, N=2805, increment_borders=array([0.16380276, 0.2374103 , 0.34521773, 0.50861646, 0.76848007,
:        1.22710819, 1.91382611, 2.37367332, 2.63339598, 2.79661594,
:        2.90460705, 2.9777899 ]), vegas_iterations=3483)
...
#+RESULTS:
[[file:./.ob-jupyter/97ae6a6129a4a8faac22c9005832a9e1488befef.png]]
...
#+begin_example
  ...
  <ipython-input-198-b267fe9317cd> in <module>
        1 cosθ_sample, cosθ_efficiency = \
  ----> 2     monte_carlo.sample_unweighted_array(sample_num, dist_cosθ,
        3                                         interval_cosθ, report_efficiency=True)
        4 cosθ_efficiency
...
#+begin_example
  ...
  TypeErrorTraceback (most recent call last)
  <ipython-input-202-22a484717aae> in <module>
        1 cosθ_sample_tuned, cosθ_efficiency_tuned = \
  ----> 2     monte_carlo.sample_unweighted_array(sample_num, dist_cosθ,
        3                                         interval_cosθ, report_efficiency=True,
        4                                         upper_bound=[upper, upper_int])
        5 cosθ_efficiency_tuned
...
#+RESULTS:
[[file:./.ob-jupyter/8e54f68b8100db4c3ea9e98825c67c859758d934.png]]
...
#+begin_example
  ...
  TypeErrorTraceback (most recent call last)
  <ipython-input-208-bd7585e9f6a0> in <module>
  ----> 1 momentum_sample = sample_momenta(sample_num, interval_cosθ, charge, esp)
        2 momentum_sample

  <ipython-input-206-9b3d8989b9a6> in sample_momenta(sample_num, interval, charge, esp, seed)
       15     """
       16     cosθ_sample = \
  ---> 17         monte_carlo.sample_unweighted_array(sample_num,
       18                                             lambda x:
       19                                               diff_xs_cosθ(x, charge, esp),
...
#+RESULTS:
[[file:./.ob-jupyter/3c43725ca1e01b8cc00477b0d3b01b6701e65836.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/cacf3bf46ee6b4b2cfd969010ed6ee92bc4a6544.png]]
...
#+begin_example
  ...
  TypeErrorTraceback (most recent call last)
  <ipython-input-212-ad8c40d00e48> in <module>
  ----> 1 η_sample, η_efficiency = monte_carlo.sample_unweighted_array(
        2     sample_num, dist_η, interval_η, report_efficiency=True
        3 )
        4 tex_value(
        5     η_efficiency * 100,
...
#+RESULTS:
:RESULTS:
| <Figure | size | 432x288 | with | 1 | Axes> | <matplotlib.axes._subplots.AxesSubplot | at | 0x7f15fef337c0> |
[[file:./.ob-jupyter/cafb1285c1aac19a880995757bb617dc13671985.png]]
:END:
...
#+RESULTS:
: array([-0.9866143 , -0.96956705, -0.93035805, -0.83748641, -0.59838645,
:         0.00744834,  0.60584137,  0.84012257,  0.93129207,  0.96949031,
:         0.9866143 ])
...
#+RESULTS:
:RESULTS:
: <matplotlib.legend.Legend at 0x7f15fea7c490>
[[file:./.ob-jupyter/6996486982a372c24bb2bc1e82c111c4f4f3f908.png]]
:END:
...
#+RESULTS:
[[file:./.ob-jupyter/2c062bb9c19e2317486326ffd59f30ebf2a7a35f.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/242a779e52d60ac390200eb1c503500dbd23404d.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/8ae758dbb63db99ecb2422167f32fafd5a9e4c48.png]]
