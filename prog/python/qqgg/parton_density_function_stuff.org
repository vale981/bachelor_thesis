...
#+RESULTS:
[[file:./.ob-jupyter/70a6711134c57d1fb387054da215e61306847ff2.png]]
...
#+begin_src jupyter-python :exports both :results raw drawer
  ...
  pT_hist = np.histogram(observables.p_t(mom[3]), bins=bins)
...
#+RESULTS:
[[file:./.ob-jupyter/2c310e5b6eb61c63f4995a3910eb29f84cd985a5.png]]

The invariant mass is not constant anymore.
#+begin_src jupyter-python :exports both :results raw drawer
  bins = np.logspace(*np.log10([2 * min_pT, 2 * e_proton]), 51)
  inv_m_hist = np.histogram(observables.inv_m(mom[2], mom[3]), bins=bins)
...
#+RESULTS:
[[file:./.ob-jupyter/fb884d16eecfcf1227597756ebe301246bed5b23.png]]
...
#+RESULTS:
[[file:./.ob-jupyter/399cea72d1864ed4c982bf043d345417000067df.png]]
