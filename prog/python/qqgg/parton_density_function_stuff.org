...
#+begin_src jupyter-python :exports both :results raw drawer
  observables.o_angle_cs(mom[2], mom[3])
#+end_src
...
: <ipython-input-44-d7257f074b8c> in <module>
: ----> 1 observables.o_angle_cs(mom[2], mom[3])
:
: AttributeError: module 'tangled.observables' has no attribute 'o_angle_cs'
:END:
