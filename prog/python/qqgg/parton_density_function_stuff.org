...
** TODO Switching Horses: Sampling η
...
#+RESULTS:
:RESULTS:
| <matplotlib.lines.Line2D | at | 0x7fb941f6c460> |
...
#+RESULTS:
: array([[-1.4068744 ,  0.42336237,  0.11719838],
:        [ 0.40627558,  0.15550581,  0.05632906],
:        [-1.37303579,  0.01976801,  0.14302427],
:        ...,
:        [-1.74788671,  0.39655784,  0.01929707],
:        [ 2.04366109,  0.02030932,  0.0756727 ],
:        [ 1.2298751 ,  0.03751999,  0.328602  ]])
...
#+begin_src jupyter-python :exports both :results raw drawer
  draw_histo(result[:, 0], "asht")
#+end_src

#+RESULTS:
:RESULTS:
| <Figure | size | 432x288 | with | 1 | Axes> | <matplotlib.axes._subplots.AxesSubplot | at | 0x7fb94199f5e0> |
[[file:./.ob-jupyter/bef8f09af4816e84b360d7648ed68b35124f0357.png]]
:END:
